...
function linesOf(text) {
    ...
    for (let index = 0; index < lines.length; index += 1) {
        ...
        if (line !== undefined && line.endsWith('\r'))
...
function editScript(before, after, maxCells) {
    ...
    while (prefix < common && before[prefix] === after[prefix])
        prefix += 1;
    let suffix = 0;
